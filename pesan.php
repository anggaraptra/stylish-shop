      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama-produk" name="nama_produk" value="<?= $produk["nama"]; ?>" readonly>
          </div>
          <div class="mb-3">
            <label for="harga-produk" class="form-label">Harga Produk</label>
            <input type="text" class="form-control" id="harga-produk" name="harga" value="<?= rp($produk["harga"]); ?>" readonly>
          </div>
          <div class="mb-3">
            <label for="" class="form-label d-flex">Gambar Produk</label>
            <img src="img-produk/<?= $produk["gambar"]; ?>" width="300" height="300" class="img-fluid mt-3 rounded gambar-produk" alt="">
          </div>
        </div>
